...
tf_percent <- ggplot(melted_df, aes(x = Sample, y = value, fill = variable,
                ...
                scale_fill_manual(values = c("#eca087", "#be4e31"),
...
png(file = "Latex/Figures/motifs_in_samples.png", width = 500)
motifs
dev.off()
```
...
png(file = "Latex/Figures/motif_intersections.png", width = 900)
motif_intersects
dev.off()
