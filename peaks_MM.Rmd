...
tf_percent <- ggplot(data = motif_data, aes(x = Sample, y = Peak_count)) + 
                geom_bar(position = 'dodge', stat = "identity",
                         fill = "#d88f2f", colour = "#bb4d0d") +
                geom_bar(position = 'dodge', data = motif_data,
                         aes(x = Sample, y = Motif_count), stat = "identity",
                         fill = "#661a03", colour = "#53210a") +
                geom_text(aes(label = Percentage), size = 4, vjust = -.5,
                         position = position_dodge(width = 0.9)) +
