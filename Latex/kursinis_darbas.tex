...
Prieiga per internetą \href{http://gtrd.biouml.org/\#!}
{http://gtrd.biouml.org/\#!} (žiūrėta 2022 m. birželio 6 d.).}
...
persidengiančių regionų skaičius yra mažesnis, todėl
...
% Koeficientų, kurie buvo gauti tarp identiškų eksperimentų, nevaizdavau.
% Funkcijoje jaccard bendrų elementų tarp A ir B skaičių padalinu iš
% šiek tiek pakoreguoto A pikų skaičiaus. Panaudojau reduce() funkciją,
% nes jos nenaudojant tarp kelių identiškų eksperimentų koeficientas nebuvo
% lygus 1, o buvo lygus truputį mažesniam dydžiui. Panagrinėjau atskirus
% eksperimentus, rezultatus ir, pasirodo, kad keliuose eksperimentuose buvo
% neapjungtų pikų intervalų, kurie buvo apjungiami intersect() funkcijos.
% Panaudojus reduce() funkciją, problema išsisprendė. Jei įstrižainė būtų
% atvaizduota, jos koeficientai būtų lygūs 1.
...
13520. Tai leidžia daryti išvadą, kad \emph{tbx5} transkripcijos faktoriaus
...
skaičius rodo, kad papildomas veikimas inhibitoriais turi
...
\begin{itemize}
    ...
    \item \textbf{75.439 \%} - tarp mėginio su T antigeną ekspresuojančiomis
            širdies fibroblastų ląstelėmis ir trečios biologinės replikos.
  \end{itemize}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TBX5 MOTYVO PROCENTINĖS DALIES NUSTATYMAS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\emph{Tbx5} motyvo pasiskirstymas mėginiuose}
% \emph{Tbx5}Tbx5 motyvų skaičius mėginiuose pavaizduotas sudėtinėje
% juostinėje diagramoje, kur {spalva} žymi nustatytų \emph{Tbx5}
% motyvų skaičių, o {spalva} žymi bendrą regionų skaičių mėginiuose.
