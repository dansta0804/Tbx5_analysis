...
Vaizduojamuose grafikuose (4 pav.) didžiausias pikų skaičius po normalizavimo
nustatytas penktoje, vienuoliktoje ir devynioliktoje chromosomose. Šiose
chromosomose didžiausią pikų skaičių turėjo mėginys, kuriame tirtos iš naminių
pelių širdies raumens išskirtos ląstelės, bei mėginys, kuriame embrionų
fibroblastai veikti AGHMT faktorių komplektu. Taip pat galima pastebėti, kad
pastarojo mėginio pikų skaičius beveik visose chromosomose yra daug didesnis
nei kituose mėginiuose apskaičiuotas pikų skaičius.
...
(angl. \emph{Mouse Genome Informatics}) svetainės duomenimis, vienuoliktos
\emph{Mus musculus} chromosomos dydis - 122 megabazės, todėl gautas didžiausias
pikų skaičius šioje chromosomoje gali indikuoti, kad prie šioje chromosomoje
esančių nukleotidų sekų transkripcijos faktoriai jungiasi dažniau nei kitose
chromosomose.
...
\begin{table}[htb]
    ...
    \hline
    \textbf{Mėginys} & \textbf{\thead{Identifikuotas\\ TF}} &
                       \textbf{\thead{Identifikuoto TF\\ procentinė dalis}} &
                       \textbf{\thead{Tbx5 motyvą turinčių\\ pikų dalis}} \\
    \hlineB{2.5}
    \multirow{3}{*}{\textbf{\emph{crdc\_mscl\_r1\_2*}}} & Tbx6(T-box)  & 
                    20.28\% & \multirow{3}{*}{54.87\%} \\
    \cline{2-3}                                 & Tbet(T-box)  & 16.48\% & \\
    \cline{2-3}                                 & Eomes(T-box) & 25.49\% & \\
    \hlineB{2.5}
    \multirow{3}{*}{\textbf{\emph{emb\_fibr\_r1\_4*}}} & Mef2b(MADS) &
                    15.60\% & \multirow{3}{*}{44.22\%} \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DE NOVO MOTYVŲ BIOLOGINĖS FUNKCIJOS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
