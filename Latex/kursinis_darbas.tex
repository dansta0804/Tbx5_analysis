...
tyrimo žingsniais. Šio etapo metu buvo sugeneruoti \emph{html}
...
pateiktame \emph{fasta} formatu.

Trečioje lentelėje (lentelė 3) kiekvienam mėginiui pavaizduoti trys
...
\begin{table}[htb]
    \newcolumntype{M}[1]{>{\centering\arraybackslash}m{#1}}
    \small
    \caption*{3 lentelė. Identifikuotų motyvų pavyzdžiai}
...
Pirmajame ir paskutiniame mėginyje, kurie atitinkamai pažymėti
\emph{mm\_2\_cardiac\_muscle\_r1} ir \emph{mm\_3\_cardiac\_fibr\_r1},
\emph{Tbx5} motyvo \emph{p} vertės buvo mažiausios, o procentinė
dalis - didžiausia. Palyginus šių mėginių rezultatus su 4.4
dalyje gautais tų pačių mėginių rezultatais pastebimas didelis
procentinės dalies neatitikimas, tačiau šie procentai
apskaičiuoti, naudojantis skirtingais metodais. Taip pat 4.4
dalyje naudota pozicinė svorių matrica neatitinka šioje dalyje
identifikuoto \emph{Tbx5} motyvo pozicinės svorių matricos.

Ketvirtoje lentelėje (lentelė 4) nurodytas bendras identifikuotų
motyvų skaičius kiekvienam mėginiui.

\begin{table}[htb]
    \newcolumntype{M}[1]{>{\centering\arraybackslash}m{#1}}
    \small
    \caption*{4 lentelė. Identifikuotų motyvų skaičius mėginiuose}
    \begin{tabular}{|c|c|c|c|c|}
    \hline
    \textbf{Mėginys} & \textbf{Pavadinimas} & \textbf{p vertė} &
                       \textbf{\thead{Procentinė\\ dalis}} &
